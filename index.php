...
<body class="b-<?=$site->code?>">
	<img src="i/bg-popup-china-m.jpg" style="display: none">
	<img src="i/bg-popup-china.jpg" style="display: none">
	<img src="i/transfer.png" style="display: none">
	<div class="b b-1" style="background-image: url('i/<?=$site->code?>.jpg');">
		<div class="b-block">
			...
			<div class="b-bottom">	
				<div class="b-h1-wrap">
					<h1><?=$title?></h1>
					<p class="b-subtitle"><b>Узнайте стоимость</b> вашего путешествия, ответив на несколько простых вопросов и получите <b>бесплатный трансфер в аэропорт.</b></p>
					<div class="consult">
						<a href="#b-popup-quiz-1" class="b-button orange left fancy goal-click" data-goal="CALC_OPEN" data-next="scr-1">
							...
							<p class="button-thin">путешествия <?=$site->route?></p>
						</a>
	...
	<div style="display:none;">
		...
		<div class="b-popup b-popup-quiz" id="b-popup-quiz-1">
			<form action="kitsend.php" method="POST" data-goal="CALC" id="b-quiz">
				<div class="b-quiz">
					<div class="quiz-screen scr-1">
						<h2 class="b-header-h2"><b>Рассчитайте</b> стоимость вашего&nbsp;путешествия <?=$site->route?></h2>
					...
					<div class="quiz-screen scr-3">
						<h2 class="b-header-h2">На <b>сколько ночей</b> хотели&nbsp;бы слетать <?=$site->route?>?</h2>
						<div class="quiz-answers">
							<div class="b-error-placement"></div>
					...
					<div class="quiz-screen scr-4 clearfix">
						...
						<div class="b-right">
							<p class="b-form-header">Заполните форму, чтобы получить расчёт и подарок</p>
							<p class="b-form-subtitle">Наши менеджеры рассчитают для вас <b>актуальную стоимость тура</b> и перезвонят вам в ближайшее время.</p>
							<input class="b-form-input ym-record-keys" type="text" id="name" name="name" required placeholder="Ваше имя*">
							<input class="b-form-input ym-record-keys" type="text" id="tel" name="phone" required placeholder="Ваш телефон*">
							<div class="b-office">	
								<a href="#" class="b-button orange meeting ajax transfer-but">
									<p class="button-bold">Получить расчёт </p>
									<p class="button-thin">и забрать подарок</p>
								</a>
								<a href="#b-popup-success" class="b-thanks-link fancy" style="display:none;"></a>
								<!-- <p class="small">Это просто и ни к чему не обязывает</p> -->
							</div>
							<input type="hidden" name="subject" value="Расчёт стоимости тура">
							<input type="submit" style="display: none;">
	...
	<? if( strpos($_SERVER["HTTP_HOST"], ".kru-god.ru") !== false): ?>
