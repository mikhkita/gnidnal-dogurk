...
$data = array(
	...
	"REGION" => (object) array(
		"values" => array(
			(object) array(
				"value" => "в Китай ",
				"keys" => array("хайна", "хаина"),
			),
			(object) array(
				"value" => "в Санью",
				"keys" => array("санья", "санью", "саньи", "санье"),
			),
			(object) array(
				"value" => "в Китай",
				"keys" => NULL,
...
$pattern = "#FIRST#<b>#TOUR# #REGION#</b>#REGION2# #COUNT##END#";
