		...
		<div class="b-block">
			<div class="wrapper">
				<div class="b-r-wrap clearfix"> 
					<div class="b-r-photo">
						<img src="<?=$site->code?>/i/vera.jpg">
					</div>
					<p class="b-r-name">Вера Якимова<br>
					<noindex><a href="https://vk.com/topic-63106152_30344734?post=107" class="b-r-link" target="_blank">ссылка VK</a></noindex></p>
				</div>
				<p class="b-r-header slider-anim fadeDown">«Отдыхом остались очень довольны!</p>
				<p class="b-r-text slider-anim fadeDown delay200">Хочу выразить огромную благодарность менеджеру Катюше! подобрала и посоветовала нам отличный тур на о. Хайнань пляж Дадунхай. Летали в августе 2018 года, погода была замечательная, Катюша всегда была с нами на связи, и отвечала на все наши вопросы. Отдыхом остались очень довольны! Спасибо агентству отдых круглый год! У вас замечательные сотрудники!) мы убедились в этом сами) А теперь и родителей наших отправили к вам!) и сами вернемся обязательно!)</p>
			</div>
		</div>
	</div>
	<div class="b-review">
	...
	<div class="b-review">
		<div class="b-block">
			<div class="wrapper">
				<div class="b-r-wrap"> 
					<div class="b-r-photo">
						<img src="<?=$site->code?>/i/marta@2x.jpg">
					</div>
